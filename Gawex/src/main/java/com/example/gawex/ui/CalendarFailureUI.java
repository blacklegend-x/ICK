...
//                .asRequired("Nie może być puste")
        ...
        saveButton.addClickListener(btn ->{
            ...
            if (failureService.getByDateTime(Date.valueOf(datePickerField.getValue()), Time.valueOf(timePickerField.getValue())) != null || failureService.getByDateTime(Date.valueOf(datePickerField.getValue()), Time.valueOf(timePickerField.getValue())) != null){
