...
//        typeInstallationColumn.setAutoWidth(true).setFlexGrow(1);
        ...
        saveButton.addClickListener(btn->{
            //sprawdzanie dat i godzin
            if (installationService.getByDateTime(Date.valueOf(datePickerField.getValue()), Time.valueOf(timePickerField.getValue())) != null || failureService.getByDateTime(Date.valueOf(datePickerField.getValue()), Time.valueOf(timePickerField.getValue())) != null){
